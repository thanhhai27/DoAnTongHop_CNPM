        ...
        <div class="row-grid">
            <div class="admin-sidebar">
                ...
                <div class="admin-sidebar-content">
                    <ul>
                        <li><a href="/admin/adminpage"><i class="ri-dashboard-line"></i><div class="admin-sidebar-headline">Trang chủ</div><i class="ri-add-box-line"></i></a></li>
                        <li><a href="/admin/admin_info"><i class="ri-file-info-line"></i><div class="admin-sidebar-headline">Thông tin</div><i class="ri-add-box-line"></i></a></li>
                        <li><a href="/admin/admin_custompass"><i class="ri-lock-line"></i><div class="admin-sidebar-headline">Đổi mật khẩu</div><i class="ri-add-box-line"></i></a></li>
                    </ul>
                </div>
            </div>
